...
-- | Trivial analysis
newtype NoData = NoData ()
  deriving (Eq, Show)

instance Analysis NoData Expr where
  makeA _ = NoData ()
  joinA _ _ = NoData ()
  modifyA _ eg = eg
...
hasSpecial :: Pattern Expr -> RewriteCondition NoData Expr
